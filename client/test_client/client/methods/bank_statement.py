...
from _HttpClient.core.abc.api_method import Request
from _HttpClient.types.bank_statement import BankStatement
from _HttpClient.utils.dates import convert_to_unix_time
...
class GetBankStatement(MonobankAPIMethod[BankStatement]):
    ...
    from_date: Optional[datetime] = Field(
        None, path_runtime_value=True, alias="from"
    )
    to_date: Optional[datetime] = Field(
        None, path_runtime_value=True, alias="to"
    )
